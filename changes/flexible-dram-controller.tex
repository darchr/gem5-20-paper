...
The DRAM interface contains media specific information, defining the architecture and timing parameters of the DRAM as well as the functions that manage the media specific operations like activation, precharge, refresh and low power modes~\cite{hansson-ispass}.
...
To enable support of NVM and future memory interfaces, a we use a systematic approach to refactor the DRAM controller.
