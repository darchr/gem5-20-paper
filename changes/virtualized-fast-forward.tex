...
The original full-system implementation was later extended to support syscall emulation mode on x86~\cite{} (Alex Dutu in a gem5 workshop a few years ago, http://www.m5sim.org/wiki/images/5/53/2015_ws_12_KVM-in-SE.pdf).
