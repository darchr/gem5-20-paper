...
To simplify the contribution process, we have instituted many industry-standard development methodologies including providing a \lstinline|CONTRIBUTING| document in the gem5 source.
...
Then, the user writes a Python script that describes the system under test by instantiating model objects (\lstinline|SimObjects| in gem5 terminology).
