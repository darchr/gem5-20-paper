...
We are also working on improving the interconnect model~\ref{sec:garnet} and adding support for non-volatile memories to the memory controller~\ref{sec:nvm}.
